...
return [
    ...
    */
    ...
    |
    */
    'title' => env('ADMIN_NAME', 'Dcat Admin'),
   ...
   */
    ...
    */
    'layout' => [
        ...
        'color' => env('ADMIN_LAYOUT_COLOR', 'default'),
        ...
        // light, primary, dark
        'sidebar_style' => env('ADMIN_LAYOUT_SIDEBAR_STYLE', 'light'),

        'dark_mode_switch' => env('ADMIN_DARK_MODE_SWITCH', false),

        // bg-primary, bg-info, bg-warning, bg-success, bg-danger, bg-dark
        'navbar_color' => env('ADMIN_LAYOUT_SIDEBAR_STYLE', 'bg-primary'),
    ],
