            ...
            <div class="inner">
                ...
                <div class="row gtr-200">
                    ...
                    <div class="col-12 col-12-medium">
                        ...
                        <h4>Fit</h4>
                        <span class="image fit"><img src="{{asset('assets/images/workcase/pic03.jpg')}}" alt="" /></span>
                        <div class="box alt">
                            <div class="row gtr-50 gtr-uniform">
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic08.jpg')}}" alt="" /></span></div>
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic09.jpg')}}" alt="" /></span></div>
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic10.jpg')}}" alt="" /></span></div>
                                <!-- Break -->
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic10.jpg')}}" alt="" /></span></div>
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic08.jpg')}}" alt="" /></span></div>
                                <div class="col-4"><span class="image fit"><img src="{{asset('assets/images/workcase/pic09.jpg')}}" alt="" /></span></div>
                        ...
                        <h4>Left &amp; Right</h4>
                        <p><span class="image left"><img src="{{asset('assets/images/workcase/pic09.jpg')}}" alt="" /></span>Lorem ipsum dolor sit accumsan
                            ...
                            ac pellentesque praesent tincidunt felis sagittis eget tempus vestibulum ante ipsum primis in
                            faucibus magna blandit adipiscing eu felis iaculis.</p>
                        <p><span class="image right"><img src="{{asset('assets/images/workcase/pic10.jpg')}}" alt="" /></span>Lorem ipsum dolor sit accumsan
                            interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in
                            faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu
                            faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum
                            ante ipsum primis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
                        ...
                        <div class="box">
                            <p>Felis sagittis eget tempus primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis
                                ...
                                ac adipiscing accumsan eu faucibus lorem ipsum.</p>
                        </div>
